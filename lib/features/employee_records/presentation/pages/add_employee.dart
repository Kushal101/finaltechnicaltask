...
class AddEmployees extends StatefulWidget {
  ...
  @override
  State<AddEmployees> createState() => _AddEmployeeState();
}

class _AddEmployeeState extends State<AddEmployees> {
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                      child: ListTile(
                        ...
                        title:Text(empRole[index],textAlign: TextAlign.center,),),
                      onTap: () {
                        setState(() {
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: ElevatedButton(
                                          ...
                                          child: Text(
                                              "Next ${DateFormat("EEEE").format(_nextDay)}")),
                                    ),
                                  ]),
                            ),
                            Visibility(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ElevatedButton(
                                          ...
                                          child: Text(
                                              "Next ${DateFormat("EEEE").format(_dayAfterTommorrow)}")),
                                    ),
                                    Container(
                                      width: MediaQuery.of(context).size.width *
                                          0.35,
